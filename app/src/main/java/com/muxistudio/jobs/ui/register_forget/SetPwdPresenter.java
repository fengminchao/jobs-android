 ...
 */
@PerActivity
public class SetPwdPresenter extends SubscriptionPresenter
    ...
    @Inject
    public SetPwdPresenter(UserApi userApi) {
    ...
    @Override
    public void sendResetAuthCode(String mail) {
        if (!RegexUtil.checkMail(mail)) {
            mView.showMailError("邮箱格式错误");
            return;
        }
    ...
    @Override
    public void register(String mail, String pwd, String auth) {
        if (!RegexUtil.checkMail(mail)) {
            mView.showMailError("邮箱格式错误");
            return;
        }
    ...
    @Override
    public void resetPwd(String mail, String pwd, String auth) {
        if (!RegexUtil.checkMail(mail)) {
            mView.showMailError("邮箱格式错误");
            return;
        }
    ...
    @Override
    public void attachView(@NonNull SetPwdContract.View view) {
        mView = view;
    }
