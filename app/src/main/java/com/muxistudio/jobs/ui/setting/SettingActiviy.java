...
public class SettingActiviy extends PreferenceActivity implements
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) LayoutInflater.from(this).inflate(R.layout.view_setting_bar,
                root, false);
        root.addView(toolbar, 0);
        toolbar.setNavigationOnClickListener(v -> this.finish());
        ((ListView) findViewById(android.R.id.list)).setDivider(
                App.sContext.getResources().getDrawable(R.drawable.divider_list));
    }
