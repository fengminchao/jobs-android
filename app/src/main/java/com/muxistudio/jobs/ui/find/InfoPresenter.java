...
@PerActivity
public class InfoPresenter extends SubscriptionPresenter implements InfoContract.Presenter {
    ...
    @Inject
    InfoPresenter(JobsApi jobsApi) {
        mJobsApi = jobsApi;
    }


    @Override
    public void loadData(int type, int page, boolean clean) {
        mView.showLoading();
        Logger.d(type + "");
        switch (type) {
            case 1:
    ...
    @Override
    public void searchData(String query, int page, int type, boolean clean) {
        mView.showLoading();
        Logger.d(type + "");
        switch (type) {
            case 1:
    ...
    public Subscription subscribeCareer(Observable<CareerList> careerListObservable,
            boolean isQuery, boolean clean) {
    ...
    public Subscription subscribeEmploy(Observable<EmployList> employListObservable,
            boolean isQuery, boolean clean) {
    ...
    public Subscription subscibeFulltime(Observable<FulltimeList> fulltimeListObservable,
            boolean isQuery, boolean clean) {
    ...
    @Override
    public void attachView(@NonNull InfoContract.View view) {
        mView = view;
    }
