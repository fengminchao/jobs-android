...
public class InfoFragment extends BaseFragment implements InfoContract.View {
    ...
    @Override
    public void renderInfoList(List<InfoData> infoDatas) {
    ...
    @Override
    public void renderMoreData(List<InfoData> infoDatas) {
        mInfoDataList.addAll(infoDatas);
        mInfoAdapter.notifyDataSetChanged();
    }

    @Override
    public void renderSearchData(List<InfoData> infoDatas) {
        if (mPage > 1) {
            mInfoDataList.addAll(infoDatas);
            mInfoAdapter.notifyDataSetChanged();
        } else {
    ...
    @Override
    public void enterDetailPage(int id, int type) {
